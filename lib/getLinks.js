	...
	document.querySelectorAll("a").forEach( 
		function(v) {
			...
			// var html = '<html><body style="margin: 0px; zoom: 0.7"><img style="height: 90%;" src="' + v.src + '"></body></html>';
				var uri = fullName + "?" + document.location.href + "?" + href; //"data:text/html;charset=UTF-8," + encodeURIComponent(html);
				links.push(uri);
			}
		}
	);
...
var altro = function altro() {
	...
	document.querySelectorAll(".sk-gallery-content > img").forEach( 
		function(v) {
			console.log(v);
			// var html = '<html><body style="margin: 0px; zoom: 0.7"><img style="height: 90%;" src="' + v.src + '"></body></html>';
			var uri = fullName + "?" + document.location.href + "?" + v.src; //"data:text/html;charset=UTF-8," + encodeURIComponent(html);
			links.push(uri);
		}
	);
